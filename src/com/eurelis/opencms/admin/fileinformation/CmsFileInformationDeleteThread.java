 ...
 * @since 6.0.0 
 */
public class CmsFileInformationDeleteThread extends A_CmsReportThread {

    /** The log object for this class. */
    private static final Log LOG = CmsLog.getLog(CmsFileInformationDeleteThread.class);
     ...
     */
    public CmsFileInformationDeleteThread(CmsObject cms, List<String> resourceNames) {
