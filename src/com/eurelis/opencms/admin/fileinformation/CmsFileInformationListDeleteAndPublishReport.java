 ...
 * @since 6.0.0 
 */
public class CmsFileInformationListDeleteAndPublishReport extends A_CmsListReport {
     ...
     */
    public CmsFileInformationListDeleteAndPublishReport(CmsJspActionElement jsp) {
     ...
     */
    public CmsFileInformationListDeleteAndPublishReport(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    public I_CmsReportThread initializeThread() {
        ...
        CmsFileInformationDeleteAndPublishThread deleteResourceThread = new CmsFileInformationDeleteAndPublishThread(getCms(), resources);
